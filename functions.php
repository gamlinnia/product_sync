    ...
    switch ($optionsArray['frontend_input']) {
        ...
        case 'boolean' :
            foreach ($optionsArray['options'] as $optionObject) {
                ...
                if (strtolower(trim($optionObject['label'])) == strtolower(trim($valueToBeMapped[0]))) {
...
function checkAllAttributeSetToSetAttributeGroup($new_attribute_code, $attr_collection) {
    ...
    // if the new attribute already in attribute set
    // then continue
